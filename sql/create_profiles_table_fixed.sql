...
-- This version works without requiring auth.users table permissions
...
-- Create a function to manually create/upsert profile (call this from your app after signup)
...
BEGIN
  ...
  VALUES (user_id, user_email, user_full_name, user_phone)
  ON CONFLICT (id) 
  DO UPDATE SET 
